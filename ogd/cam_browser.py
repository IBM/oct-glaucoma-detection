"""
A little GUI that allows to load and look at slices of precomputed cubes
with CAM.
"""
...
class CAMBrowser(object):
    ...
    def init_gui(self):
        ...
        self.fig = plt.figure('CAM Browser', figsize=(7, 7),
                              facecolor=bkg_color)
